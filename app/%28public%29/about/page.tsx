    ...
    <div className="space-y-12 max-w-5xl mx-auto py-6">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
          My Weather was built to solve the fragility of single-provider weather apps. By unifying leading global meteorological engines under one intelligent load balancer, we deliver instant, reliable forecasts for any coordinates on Earth.
        </p>
      </div>
